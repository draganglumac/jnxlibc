...
static void kwiksort(sortable_array *sa, int first, int last); 
static int choose_pivot(sortable_array *sa, int first, int last);
static void swap(sortable_array *sa, int i, int j);
static int partition(sortable_array *sa, int first, int last);
...
static int calculate_midpoint(int first, int last) {
...
static int choose_median_of_three(sortable_array *sa, int first, int last) {
  if (last - first > 1) {
