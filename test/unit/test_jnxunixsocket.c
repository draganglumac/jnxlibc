...
void test_create_and_destroy() {
  printf("Test creation of unix sockets");
...
void test_negative_send_stream_scenarios() {
  printf("Test negative send stream scenarios");
  fflush(stdout);
...
void test_negative_send_datagram_scenarios() {
  printf("Test negative send datagram scenarios");
  fflush(stdout);
...
void test_negative_stream_listen_scenarios() {
  printf("Test negative stream listen and receive scenarios");
  fflush(stdout);
...
void test_stream_ipc_comms() {
  printf("Test unix stream socket inter-process communication.\n");
  fflush(stdout);
  remove("stream_sun");
...
void test_binary_data_in_stream_ipc_comms() {
  printf( "Test binary data sent and received via stream socket\n");
  fflush(stdout);
...
void test_large_data_in_stream_ipc_comms() {
  printf( "Test large data sent and received via stream socket\n");
  fflush(stdout);
  remove("large_stream");
...
void test_negative_datagram_listen_scenarios() {
  printf("Test negative datagram listen scenarios");
  fflush(stdout);
...
void test_datagram_ipc_comms() {
  printf("Test unix datagram socket inter-process communication.\n");
  fflush(stdout);
  remove("datagram_sun");
...
void test_binary_data_in_datagram_ipc_comms() {
  printf( "Test binary data sent and received via datagram socket\n");
  fflush(stdout);
...
void test_large_data_in_datagram_ipc_comms() {
  printf( "Test large data sent and received via datagram socket\n");
  fflush(stdout);
...
int main(int argc, char **argv) {
  printf("Starting unix socket tests\n");
